...
const STATIC_SECTIONS = [
  ...
  { 
    id: 'data', 
    title: '3. Data & Models', 
    content: `DATA & MODELS\n\nENTITIES:\n- User\n- Project\n- Environment\n- Deployment\n- VoiceCommandLog (ephemeral)\n\nRELATIONAL STRUCTURE:\n- One-to-many (User -> Project)\n- One-to-one (Project -> Environment)\n\nANTICIPATED VOLUME:\nSmall to medium scale initially, leveraging Firebase/Supabase for real-time state synchronization and document storage.` 
  },
  { 
    id: 'constraints', 
  ...
  { 
    ...
    content: `COMPETITION ANALYSIS\n\nCOMPETITORS:\n- Cursor IDE\n- GitHub Copilot Workspace\n- Vercel v0\n\nDIFFERENTIATORS:\n- Voice-First Native: Built from the ground up for spoken natural language, not just text prompts.\n- Zero-Config Infrastructure: Automatically provisions backend (Firebase) and frontend (Vercel) upon project creation, removing the "blank canvas" setup friction.` 
  },
  { 
    id: 'pricing', 
    title: '8. Pricing', 
