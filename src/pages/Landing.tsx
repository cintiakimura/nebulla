...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-white font-sans selection:bg-primary/30 antialiased">
      ...
      <section className="relative flex flex-col justify-center px-6 pt-8 pb-10 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto w-full flex flex-col md:flex-row md:items-center md:justify-between gap-12 md:gap-16">
          ...
          <div className="flex flex-col sm:flex-row gap-6 text-left">
            <div className="flex-1 rounded-2xl bg-sidebar-bg border border-border p-6 md:p-8 min-w-[200px]">
              <p className="text-3xl font-light text-[#9cdcfe] mb-1">Free</p>
              <p className="text-[15px] text-muted mb-4">Try the builder</p>
              <button
                onClick={() => navigate("/login")}
                className="w-full py-3 bg-primary text-white font-medium rounded-lg hover:bg-primary/90 transition-colors text-[15px] mb-4"
              >
                Sign up now
              </button>
            ...
            <div className="flex-1 rounded-2xl bg-sidebar-bg border border-border p-6 md:p-8 min-w-[200px]">
              ...
              <p className="text-[15px] text-muted mb-4">Pro — contact for pricing</p>
              <button
      ...
      <section className="px-6 pt-10 pb-16 md:pt-12 md:pb-24 border-t border-border">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl bg-sidebar-bg border border-border p-8 md:p-10">
            ...
            <div className="rounded-2xl bg-sidebar-bg border border-border p-8 md:p-10">
              ...
              <div className="flex flex-wrap gap-2">
                {["GitHub", "Domain", "One-click deploy"].map((label) => (
                  <span
                    key={label}
                    className="px-3 py-1.5 rounded-full bg-primary/20 border border-border text-[15px] text-primary"
                  >
                    {label}
                  </span>
                ))}
      ...
      <footer className="px-6 py-16 border-t border-border">
        <p className="text-center text-[15px] text-muted max-w-md mx-auto leading-relaxed">
