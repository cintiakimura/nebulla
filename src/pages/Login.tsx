...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-white font-sans">
      <button
        onClick={() => navigate("/")}
        className="absolute top-8 left-8 text-muted hover:text-primary flex items-center gap-2 transition-colors"
      >
        <ArrowLeft size={20} />
        Back
      </button>
      ...
      <div className="w-full max-w-md bg-[#252526] border border-[#2d3f4f] rounded-2xl p-8 shadow-2xl">
        ...
        {useSupabase ? (
            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 bg-editor-bg border border-border rounded-lg text-white placeholder-muted focus:border-primary outline-none"
                  autoComplete="email"
                />
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-primary text-white font-medium rounded-lg hover:bg-primary/90 disabled:opacity-60 transition-all"
                >
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-left text-sm text-muted mb-1">Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="you@example.com"
                  className="w-full pl-10 pr-4 py-3 bg-editor-bg border border-border rounded-lg text-white placeholder-muted focus:border-primary focus:ring-1 focus:ring-primary outline-none"
                  autoComplete="email"
                />
              </div>
            </div>
            <div>
              <label className="block text-left text-sm text-muted mb-1">Password</label>
              <div className="relative">
